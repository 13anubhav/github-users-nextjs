  ...
  return (
    <div className={`container ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <style jsx>{`
        ...
        .dark-mode {
          background: linear-gradient(135deg, #30cfd0 0%, #112047 100%);
          color: #ffffff;
        }
        ...
        .search-input:focus {
          outline: none;
          box-shadow: 0 0 0 3px ${isDarkMode ? 'rgba(255,255,255,0.2)' : 'rgba(253,160,133,0.5)'};
        }

        .search-button {
          background-color: ${isDarkMode ? '#30cfd0' : '#fda085'};
          color: white;
          border: none;
          border-radius: 50%;
          width: 50px;
        ...
        .profile-link:hover {
          background-color: ${isDarkMode ? '#330867' : '#f6d365'};
        ...
        .loader {
          ...
          border-top: 4px solid ${isDarkMode ? '#30cfd0' : '#fda085'};
          border-radius: 50%;
          width: 50px;
          height: 50px;
