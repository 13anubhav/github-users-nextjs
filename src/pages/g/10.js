  ...
  return (
    <div className={`container ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
            ...
            <div className="user-grid">
              {usersOnCurrentPage.map((user, index) => (
                <div key={user.id} className="user-card">
                  <div className="card-header" style={{ backgroundColor: `hsl(${index * 45}, 70%, 50%)` }}></div>
      ...
      <style jsx>{`
        ...
        .search-input:focus {
          outline: none;
          box-shadow: 0 0 0 3px ${isDarkMode ? 'rgba(255,255,255,0.2)' : 'rgba(132,250,176,0.5)'};
        }

        .search-button {
          background-color: ${isDarkMode ? '#49a09d' : '#84fab0'};
          color: ${isDarkMode ? '#ffffff' : '#333333'};
          border: none;
          border-radius: 50%;
          width: 50px;
        ...
        .profile-link:hover {
          background-color: ${isDarkMode ? '#5f2c82' : '#8fd3f4'};
        ...
        .loader {
          ...
          border-top: 4px solid ${isDarkMode ? '#49a09d' : '#84fab0'};
          border-radius: 50%;
          width: 50px;
          height: 50px;
